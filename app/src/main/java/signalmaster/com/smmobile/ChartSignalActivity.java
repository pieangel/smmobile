...
public class ChartSignalActivity extends AppCompatActivity {

    private SmChartFragment smChartFragment1 = null;
    private SmChartFragment smChartFragment2 = null;
    private SmChartFragment smChartFragment3 = null;

    public ChartSignalActivity() {
        smChartFragment1 = SmChartFragment.newInstance("signal_premium_upper");
        smChartFragment2 = SmChartFragment.newInstance("signal_premium_middle");

        smChartFragment3 = SmChartFragment.newInstance("signal_premium_lower");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*SChartFragment sChartFragment = new SChartFragment();
        SChartFragment2 sChartFragment2 = new SChartFragment2();
        SChartFragment3 sChartFragment3 = new SChartFragment3();*/
        /*Bundle bundle = new Bundle();
        sChartFragment.setArguments(bundle);*/
        ...
        smChartFragment2.setChartCycle(5);
        smChartFragment3.setSymbolCode(symbolCode);
        smChartFragment3.setChartType(SmChartType.MIN);
        smChartFragment3.setChartCycle(30);
        ...
        fragmentTransaction.replace(R.id.fragment_container3,smChartFragment3);
