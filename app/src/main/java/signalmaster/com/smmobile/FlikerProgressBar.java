...
public class FlikerProgressBar extends View implements Runnable {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        try {
            ...
            loadingColor = ta.getColor(R.styleable.FlikerProgressBar_loadingColor, Color.rgb(255, 0, 0));
            stopColor = ta.getColor(R.styleable.FlikerProgressBar_stopColor, Color.rgb(0, 0, 255));
    ...
    private void init() {
        ...
        textRect = new Rect();
        bgRectf = new RectF(borderWidth, borderWidth, getMeasuredWidth() - borderWidth, 200 - borderWidth);
    ...
    private void initPgBimap() {
        pgBitmap = Bitmap.createBitmap(getMeasuredWidth() - borderWidth, 200 - borderWidth, Bitmap.Config.ARGB_8888);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(1, 1, getMeasuredWidth() - 1, 199, myPaint);
        */
    }
    ...
    private void drawProgress(Canvas canvas) {
        ...
        pgCanvas.save();
        pgCanvas.clipRect(0, 0, right, 200);
