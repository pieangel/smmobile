...
public class PortFolioAdapter extends RecyclerView.Adapter<PortFolioAdapter.ViewHolder> {
    ...
    ArrayList<Portfolio> portList = portMgr.getPortList();*/
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        //public PortFolioAdapter parentAdapter = null;
    ...
    public PortFolioAdapter(ArrayList<String> list) {
        portList = list;
    }
    ...
    public PortFolioAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType){
        ...
        PortFolioAdapter.ViewHolder vh = new PortFolioAdapter.ViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(PortFolioAdapter.ViewHolder holder, final int position) {
