...
public class SmProgressBar extends View {
    ...
    public SmProgressBar(Context context, int _width) {
        this(context, _width, null);
    }

    public SmProgressBar(Context context, int _width, AttributeSet attrs) {
        this(context, _width, attrs, 0);
    }

    public SmProgressBar(Context context, int _width, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        radius = a.getDimensionPixelSize(R.styleable.MProgressBar_rprogress, radius);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (0 >= progressWidth) {
            ...
            // 프로그래스 너비 - 여기서는 프로그레스 높이가 너비가 된다.
